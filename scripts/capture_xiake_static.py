"""Capture static slides (one per slide) for 侠客行."""
import asyncio
import os
import glob

SLIDE_DIR = os.path.abspath("D:/code/MyWord/xhs-output/xiake_slides")
HTML_PATH = os.path.abspath("D:/code/MyWord/xhs-output/侠客行_static.html")
